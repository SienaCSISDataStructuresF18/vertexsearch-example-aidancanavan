...
public class VertexSearch {
    ...
    public static void main(String args[]) {
        ...
        if(points[check].getLat()>north.getLat()){north = points[check];}
        if(points[check].getLat()<south.getLat()){south = points[check];}
        if(points[check].getLng()>east.getLng()){east = points[check];}
        if(points[check].getLng()<north.getLng()){west = points[check];}
        }
